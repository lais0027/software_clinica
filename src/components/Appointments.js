                    ...
                    return (
                      ...
                      >
                        ...
                        {dayAppointments.length > 3 && (
                          <div
                            className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full text-white text-xs flex items-center justify-center ${
                              isSelected
      ...
      >
        <div>
          ...
          <p className="text-gray-600">
            Administra las citas de todos tus pacientes
          </p>
        </div>
                    ...
                    .map((appointment, index) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div
                            className={`px-4 py-2 rounded-xl text-sm font-medium border flex items-center gap-2 ${getStatusColor(appointment.status)}`}
                          >
